...
| `compat_install_alias` | 1 | Guards IX-01 Unix `lba -> libra` and plan-20260714 PD-10 Windows `lba.cmd` creation, same-version repair/idempotency, CLI/env opt-outs, foreign-path preservation, and managed uninstall | `install.sh`, `install.ps1`, `tests/compat/install_alias_smoke.sh`, `tests/compat/install_alias_windows.ps1`, `README.md`, `README.zh-CN.md` |
